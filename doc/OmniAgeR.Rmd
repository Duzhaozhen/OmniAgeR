...
| `Weidner` | Chronological | `EpiAge()`,`Weidner()` |
| `IntrinClock` | Chronological | `EpiAge()`,`IntrinClock()` |
| `Garagnani` | Chronological | `EpiAge()`,`Garagnani()` |
...
| `HepatoXu` | Hepatocellular Carcinoma Risk | `HepatoXu()` |
| `CVD_Westerman` | Coronary Heart Disease Risk| `CVD_Westerman()` |
| `CompSmokeIndex` | Smoking Index | `CompSmokeIndex()` |
