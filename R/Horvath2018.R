...
#' horvath2018ClockOut <- horvath2018Clock(hannum_bmiq_m)


horvath2018Clock <- function(betaM,
                             minCoverage = 0.5, 
                             verbose = TRUE) {
  data("Horvath2018Coef", envir = environment())
  
  predAgev <- .calLinearClock(betaM, Horvath2018Coef, "horvath2018Clock", 
                              minCoverage,verbose)
  # transformation
